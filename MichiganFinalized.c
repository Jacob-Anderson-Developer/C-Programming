...
int main(void)
{
	...
	int i = 0, tempTot = 0, warmdays = 0, colddays = 0, hotdays = 0, sum = 0, loop = 0;
	float avgTemp = 0.0f;
	...
	printf("Enter the high temperature for 14 days below");  //Accepts user input for each of the 14 array elements
...
{
	printf("\n\nThe highest temperature in the last two weeks was: %d", temperature[ctr]); //Prints highest temp
} 
